...
int ReadFile(int fd, char *arr, int isize)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->permission != READ && UFDTArr[fd].ptrfiletable->ptrinode->permission != READ + WRITE)  return -1;
...
int main()
{
   ...
   //Shell
    while(1)
    {
        ...
        else if(count == 3)     //jar command madhe 3 words astil tar
        {
